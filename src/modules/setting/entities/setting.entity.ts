...
@Index('settings_production_roll_id_index', ['productionRollId'], {})
@Entity('settings', { schema: 'modema' })
export class Setting {
  ...
  @Column('int', {
    name: 'campaign_pet_discount_amount',
    default: () => "'14'",
  })
  campaignPetDiscountAmount: number;

  @Column('int', {
    name: 'campaign_pet_min_donation_amount',
    default: () => "'1'",
  })
  ...
  @Column('int', { name: 'lottery_draw', nullable: true, default: () => "'0'" })
  lotteryDraw: number | null;

  @Column('varchar', {
    name: 'lottery_draw_numbers',
    nullable: true,
    length: 255,
  })
  lotteryDrawNumbers: string | null;

  @Column('int', {
    name: 'lottery_draw_brace',
    nullable: true,
    default: () => "'0'",
  })
  lotteryDrawBrace: number | null;

  @Column('varchar', {
    name: 'lottery_draw_numbers_brace',
    nullable: true,
    length: 255,
  })
  lotteryDrawNumbersBrace: string | null;
}
